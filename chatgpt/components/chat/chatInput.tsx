                    ...
                    {file.file_url ? (
                      <div className="relative w-20 h-20 rounded-lg overflow-hidden border bg-white">
                        ...
                        <Button
                          ...
                          className="absolute -top-2 -right-2 h-4 w-4 p-0 bg-red-500 hover:bg-red-600 text-white rounded-full"
                        >
                          <X className="w-3 h-3" />
                        </Button>
                      </div>
                    ) : (
                      <div className="w-20 h-20 rounded-lg border bg-white flex flex-col items-center justify-center p-2 relative">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => removeFile(index)}
                          className="absolute z-100 -top-2 -right-2 h-6 w-6 p-0 bg-red-500 hover:bg-red-600 text-white rounded-full"
                        >
                          <X className="w-3 h-3" />
                        </Button>
                      </div>
